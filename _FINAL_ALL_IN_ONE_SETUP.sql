...
-- YT VIDEOS
CREATE POLICY "Assigned users or Admins can view videos" ON yt_videos FOR SELECT USING (get_my_role() IN ('owner', 'admin') OR assigned_to = auth.uid() OR created_by = auth.uid());
CREATE POLICY "Admins+ can create videos" ON yt_videos FOR INSERT WITH CHECK (get_my_role() IN ('owner', 'admin'));
CREATE POLICY "Admins+ can update videos" ON yt_videos FOR UPDATE USING (get_my_role() IN ('owner', 'admin') OR assigned_to = auth.uid());
CREATE POLICY "Admins+ can delete videos" ON yt_videos FOR DELETE USING (get_my_role() IN ('owner', 'admin'));
...
-- FREELANCE ORDERS
CREATE POLICY "Assigned users or Admins can view orders" ON freelance_orders FOR SELECT USING (get_my_role() IN ('owner', 'admin') OR assigned_to = auth.uid() OR created_by = auth.uid());
CREATE POLICY "Admins+ can create orders" ON freelance_orders FOR INSERT WITH CHECK (get_my_role() IN ('owner', 'admin'));
CREATE POLICY "Admins+ can update orders" ON freelance_orders FOR UPDATE USING (get_my_role() IN ('owner', 'admin') OR assigned_to = auth.uid());
CREATE POLICY "Admins+ can delete orders" ON freelance_orders FOR DELETE USING (get_my_role() IN ('owner', 'admin'));

-- GENERAL TASKS
CREATE POLICY "Assigned users or Admins can view tasks" ON tasks FOR SELECT USING (get_my_role() IN ('owner', 'admin') OR assigned_to = auth.uid() OR created_by = auth.uid());
CREATE POLICY "Admins+ can create tasks" ON tasks FOR INSERT WITH CHECK (get_my_role() IN ('owner', 'admin'));
CREATE POLICY "Admins+ can update tasks" ON tasks FOR UPDATE USING (get_my_role() IN ('owner', 'admin') OR assigned_to = auth.uid());
CREATE POLICY "Admins+ can delete tasks" ON tasks FOR DELETE USING (get_my_role() IN ('owner', 'admin'));
